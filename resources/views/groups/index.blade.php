<x-app-layout>
    <x-slot name="title">My Groups</x-slot>
    <x-slot name="navigation"></x-slot>
    <body class="groups-page users-page">
        <div class="container">
            <div class="grid-x grid-margin-x mb-25">
                <div class="auto cell">
                    <div class="search-header">My Groups</div>
                </div>
                <div class="shrink cell">
                    <a href="{{ route('groups.explore') }}" class="button button-blue"><i class="fa-duotone fa-magnifying-glass"></i>&nbsp; Find Groups</a>
                    &nbsp;
