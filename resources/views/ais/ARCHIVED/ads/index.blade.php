        ...
        <div class="col-md-6 col-xl-6">
            ...
            <div class="card mb-4">
                <a href="reviewclothing.html" class="text-body font-weight-normal text-decoration-none">
                    @if(App\Models\Ad::where('pending', '1')->get()->count() > 0)
                    ...
                    @endif
                    <div class="card-body">
                        <h2 class="mb-1">{{ App\Models\Ad::where('pending', '1')->get()->count() }}</h2>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-12 text-center">
                            <h2 class="mb-0">{{ number_format(App\Models\Ad::get()->count()) }}</h2>
                            <p class="mb-0">Ads</p>
                        </div>
                    </div>
                    <form class="row">
